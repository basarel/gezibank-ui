  ...
  return (
    <div className='grid gap-3 md:gap-4'>
      ...
      <div className='flex flex-col gap-3 md:grid md:grid-cols-2 md:gap-3'>
          ...
          <Input.Wrapper>
            ...
            error?.birthDate_year ? (
              <Input.Error className='pt-1'>
                {error?.birthDate?.message ?? 'Geçersiz tarih'}
              </Input.Error>
            ) : null}
          </Input.Wrapper>
        ...
        <Collapse
          in={methods.getValues(`${namePrefix}.nationality_Check`)}
          ...
          <Alert>
            <div className='flex flex-col gap-3'>
              <p className='flex gap-2'>
                ...
                <span>
                  Konaklayan misafirin TC vatandaşı olmadığını belirtiniz.
                  Rezervasyonda belirtilen tesis fiyatları, sadece TC
                  vatandaşları için uygulanabilir. Misafirin TC haricinde farklı
                  bir ülke vatandaşı olması durumunda, tesis fiyat farkı talep
                  edilebilir.Böyle bir durum oluşması halinde ilgili
                  birimlerimiz sizinle iletişime geçecektir.
                </span>
              </p>
              <p className='flex gap-2'>
                <span className='inline-flex pt-1 text-lg'>
                ...
                <span>
                  Please specify that the guest staying at the property is not a
                  T.R. citizen. The property prices stated in the reservation
                  can only be applied to the T.R. citizens. In case the guest is
                  a citizen of a different country other than the Turkish
                  Republic, the property price difference may be claimed. In
                  such a case, our relevant departments will contact you.
                </span>
              </p>
            </div>
          </Alert>
