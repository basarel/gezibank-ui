...
const UpComingHolidays: React.FC<IProps> = ({ data }) => {
  return (
    <div className='flex flex-col items-center'>
      <div className='relative mx-auto mt-5 w-fit border-blue-800 py-3 text-center text-2xl font-bold text-blue-700 md:text-3xl'>
        Yaklaşan Tatiller
        <div className='absolute bottom-0 left-1/2 h-2 w-12 -translate-x-1/2 rounded-full bg-blue-700'></div>
      </div>
      <Carousel
        slideGap='lg'
        withIndicators
