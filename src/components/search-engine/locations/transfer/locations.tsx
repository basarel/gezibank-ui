...
export const Locations: React.FC<Props> = ({
  ...
  const [locatioName, setLocationName] = useState<null | string>(defaultValue)
                  ...
                  {data.map((location) => {
                    ...
                    return (
                      <div key={Id + Name}>
                        <div
                          className={clsx(
                            'hover:text-blue-filled hover:border-s-blue-filled relative rounded-md border-s-4 border-s-transparent hover:bg-blue-100',
                            {
                              'cursor-pointer': location.Type === 7,
                            }
                          )}
                          onClick={() => {
                            if (location.Type === 7) {
                          ...
                          role={location.Type === 7 ? 'button' : undefined}
                        >
                          {/* <div className='absolute bottom-0 end-0 start-0 top-0 border-0 p-0'>
