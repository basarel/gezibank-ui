...
const HotelGuestsActions: React.FC<Props> = ({
  ...
  function handleChildAges({
    ...
    const nextState = roomState.map((room) => room)
  ...
  function handlePassengerSelect({
    ...
    const nextRoomState = roomState.map((room) => room)
      ...
      >
        ...
        <div className='flex items-center justify-between'>
          ...
          <div className='grid grid-cols-3 items-center'>
            ...
            <Text className='col-span-1 text-center' aria-label='adult-count'>
              {room.adult}
            </Text>
            <ActionIcon
              className='col-span-1'
        ...
        <div className='flex items-center justify-between'>
          <Text>
            Çocuk
            <span className='text-sm'> (0-16 Yaş arası)</span>
          </Text>
          <div className='grid grid-cols-3 items-center'>
            <ActionIcon
              className='col-span-1'
            ...
            <Text className='col-span-1 text-center' aria-label='child-count'>
              {room.child}
            </Text>
            <ActionIcon
              className='col-span-1'
