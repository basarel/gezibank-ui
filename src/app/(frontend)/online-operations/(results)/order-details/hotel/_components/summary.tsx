...
import { InstallmentSelect } from '@/app/(frontend)/reservation/(index)/_components/instalment-table'
import { useEffect, useMemo, useRef } from 'react'
import { PartialPaymentResponseType } from '@/app/(frontend)/reservation/types'
            ...
            >
              <div className='grid gap-5'>
                ...
                {installmentList && installmentList.length > 0 && (
                  <InstallmentSelect
                    value={form.getValues('installment') ?? 1}
                    onChange={(value) => {
                      form.setValue('installment', +value)
                      form.trigger('installment')
                    }}
