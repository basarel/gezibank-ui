...
import { useCarSearchResults } from '@/app/(frontend)/car/search-results/useSearchResult'
import { CarSearchResultItem } from '@/app/(frontend)/car/component/result-item'
import {
  CarSearchRequest,
  CarSearchResultItemType,
  Params,
} from '@/app/(frontend)/car/types'
...
import { useFilterActions } from '@/app/(frontend)/car/search-results/filter-actions'
