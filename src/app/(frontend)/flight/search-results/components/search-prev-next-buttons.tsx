...
import { SearchResult } from '@/app/(frontend)/car/search-results/search-result'
      ...
      {!isDomestic && activeTripKind === '1' ? (
        ...
        >
          <Button
            size='md'
            variant='outline'
            className='flex items-center gap-2 border-transparent bg-gray-200 hover:border-blue-600'
            onClick={onPrevDay}
          >
      ...
      {!isDomestic && activeTripKind === '2' && (
        ...
        >
          <Button
            ...
            size='sm'
            variant='outline'
            className='flex items-center gap-2 border-transparent bg-gray-200 py-2 font-normal hover:border-blue-600'
            onClick={onPrevDay}
          >
          ...
          <Button
            ...
            size='sm'
            variant='outline'
            className='flex items-center gap-2 border-transparent bg-gray-200 font-normal hover:border-blue-600'
            onClick={onNextDay}
          >
      ...
      {!isDomestic && !returnDate && (
        <div className='sticky top-0 z-10 flex items-center justify-between gap-1 py-2 text-center md:gap-2'>
          <Button
            ...
            size='sm'
            variant='outline'
            className='md:text-md flex items-center gap-2 border-transparent bg-gray-200 text-xs hover:border-blue-600'
            onClick={onPrevDay}
          >
            <MdKeyboardArrowLeft size={18} />
            <span className='hidden md:block'>Önceki Gün</span>
