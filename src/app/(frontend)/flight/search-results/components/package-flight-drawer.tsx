...
const PackageFlightDrawer: React.FC<IProps> = ({ data, onSelect }) => {
  ...
  return (
    <div className='space-y-4'>
          ...
          return (
            <div
              ...
              className={clsx(
                ...
                isSelected ? `border-4 border-blue-600 bg-blue-50` : 'border-4'
              )}
              role='button'
      ...
      <div className='sticky bottom-1 flex items-center md:justify-center'>
        <Button
          type='button'
          radius={'xl'}
          size='lg'
          className='w-full bg-blue-800 text-white shadow-lg hover:bg-blue-600 md:w-[200px]'
