...
const FlightSearchResultsOneWayDomestic: React.FC<IProps> = ({
  ...
  return (
    <div className='group items-center gap-x-4 rounded-lg border shadow hover:border-blue-600 hover:shadow-xl md:grid md:grid-cols-5'>
      <div className='col-span-4 grid gap-4'>
        {details.map((detail) => {
          ...
          return (
            <div
              key={detail.key}
              className='relative mt-3 grid p-3 md:mt-0 md:mt-5 md:grid-cols-3 md:p-5'
              // onClick={onSelect}
            >
              <div className='start-0-0 absolute top-1/2 mt-5 h-8 w-1 -translate-y-1/2 rounded-tr-xl rounded-br-md bg-gray-400 group-hover:bg-blue-600 md:mt-0' />
                ...
                <div className='flex gap-2'>
                  ...
                  <div className='mt-2 grow'>
                    <div className='relative'>
                      ...
                      <div className='top-[1px]text-blue-800 absolute end-0 -translate-y-1/2 rotate-90 bg-white'>
                  ...
                  <div>
                    <div className='relative text-xl leading-none'>
                      ...
                      {arrivalIsAfter && (
                        <sup className='absolute -end-2 -top-2 text-xs leading-none font-bold text-red-700'>
                          +1
                        </sup>
                      )}
                    </div>
      ...
      <div className='flex items-center justify-between border-t border-gray-200 p-3 px-3 md:grid md:justify-normal md:gap-1 md:border-0 md:py-0 md:pt-6 md:text-center'>
        <div className='text-xl font-semibold'>
          {formatCurrency(fareInfo.totalPrice.value)}
        </div>
        <UnstyledButton
          className='flex items-center px-0 text-sm font-bold text-blue-500 md:hidden'
        ...
        <UnstyledButton
          className='mx-auto hidden items-center text-sm font-bold text-blue-500 md:flex'
          onClick={toggleDetails}
        >
          {detailsOpened ? (
            <>
