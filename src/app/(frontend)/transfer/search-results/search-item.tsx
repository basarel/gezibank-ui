...
import { TransferVehicle } from '@/app/(frontend)/transfer/types'
...
export const TransferSearchItem: React.FC<Props> = ({
  ...
  return (
    <div className='group relative rounded-lg border shadow hover:border-blue-600 hover:shadow-xl'>
      <div className='start-0-0 absolute top-1/2 mt-5 h-8 w-1 -translate-y-1/2 rounded-tr-md rounded-br-md bg-gray-400 group-hover:bg-blue-600 md:mt-0' />
      <div className='grid gap-3 md:grid-cols-12 md:gap-5'>
        <div className='col-span-12 content-center px-4 md:col-span-3 md:py-3'>
          <Link href={extraPageUrl} onClick={() => onSelect(data)}>
            <Image
