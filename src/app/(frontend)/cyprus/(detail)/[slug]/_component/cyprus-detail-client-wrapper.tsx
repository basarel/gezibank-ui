...
import { FacilityProps } from '@/app/(frontend)/hotel/(detail)/[slug]/_components/facility-props'
import { Comments } from '@/app/(frontend)/hotel/(detail)/[slug]/_components/comments'
import { HotelDetailResponseHotelInfo } from '@/app/hotel/types'
import { Location } from '@/app/(frontend)/hotel/(detail)/[slug]/_components/location'
import { ImportantInfos } from '@/app/(frontend)/hotel/(detail)/[slug]/_components/important-infos'
import { MainDrawer } from '@/app/(frontend)/hotel/(detail)/[slug]/_components/main-drawer'
