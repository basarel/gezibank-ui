...
} from '@/app/(frontend)/cyprus/searchParams'
import { CyprusHotelDetailApiResponse } from '@/app/(frontend)/cyprus/types'
...
import { HotelTableOfContents } from '@/app/(frontend)/hotel/(detail)/[slug]/_components/table-of-contents'
import { HotelFeatures } from './hotel-features'
import { reservationParsers } from '@/app/(frontend)/reservation/searchParams'

import { useSelectedRoomDetailMutation } from '@/app/(frontend)/cyprus/useSelectedRoomDetailQuery'
  ...
  return (
    <>
      <div className='border-b shadow md:py-3'>
        <Container>
          <div className='relative py-1 text-sm md:hidden'>
            <button
            ...
            <div className='flex items-center gap-2'>
              ...
              <div className='flex items-center gap-2'>
                ...
                <div>{searchPassenger?.length} Kişi</div>
              </div>
