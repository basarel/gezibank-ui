...
import { useSearchRequest } from '@/app/(frontend)/bus/useSearchResults'
import {
  BusGender,
  BusSearchResultItem,
  Seat,
  SeatColors,
} from '@/app/(frontend)/bus/types'
import { BusFrame } from '@/app/(frontend)/bus/search-results/components/bus-frame'
...
import { TripDetail } from '@/app/(frontend)/bus/search-results/components/trip-detail'
