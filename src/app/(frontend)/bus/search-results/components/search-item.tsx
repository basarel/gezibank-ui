...
import { BusSearchResultItem } from '@/app/(frontend)/bus/types'
...
const BusSearchItem: React.FC<Props> = ({
  ...
  return (
    <div className='group relative rounded-lg border border-gray-300 hover:border-blue-600 hover:shadow-xl'>
