...
export const ParafParaView: React.FC<IProps> = ({ data }) => {
  ...
  const isStickerCard = data.cardNumber.substring(0, 8) == '97921020'
  const isPremiumCard = data.cardNumber.substring(0, 6) == '542694'
    ...
    <div className='grid gap-3 md:gap-5'>
      <div className='grid gap-3 md:grid-cols-3'>
        ...
        <div className='flex items-center justify-center'>
          {isStickerCard ? (
            <Image
              src='https://paraflystatic.mncdn.com/7/Content/img/paraf_sticker.png'
              alt='Paraf Kart'
              maw={105}
            />
          ) : isPremiumCard ? (
            ...
            <Image
              src='https://paraflystatic.mncdn.com/7/Content/img/paraf_kart.png'
              alt='Paraf Kart'
              maw={205}
            />
          )}
      ...
      <div>
        <div className='flex items-center gap-3 rounded-2xl bg-blue-100 p-3 text-sm text-blue-600 md:p-5'>
          <div>
