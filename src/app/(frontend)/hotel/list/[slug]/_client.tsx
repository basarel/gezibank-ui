...
import { useSearchListQuery } from '@/app/(frontend)/hotel/useListSearchQuery'
...
import { HotelSearchResultItem } from '@/app/(frontend)/hotel/search-results/results-item'
import { useState } from 'react'
import {
  HotelCampaignsResponse,
  HotelSearchResultHotelInfo,
} from '@/app/(frontend)/hotel/types'
import { HotelMap } from '@/app/(frontend)/hotel/search-results/components/maps'
...
import { SearchByName } from '@/app/(frontend)/hotel/search-results/components/search-by-name'
import { FaCheck } from 'react-icons/fa'
import { DestinationIds } from '@/app/(frontend)/hotel/search-results/components/filters/destinationIds'
import { PensionTypes } from '@/app/(frontend)/hotel/search-results/components/filters/pension-types'
import { Themes } from '@/app/(frontend)/hotel/search-results/components/filters/themes'
