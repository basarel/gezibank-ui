    ...
    <>
      <div className='grid gap-3'>
        {description?.beachPool?.trim() && (
          <div className='hidden bg-white pt-2 md:flex'>
                ...
                <div className='flex items-center gap-2'>
                  <div>
                    ...
                    <div className='flex items-center'>
                      <UnstyledButton
                        className='border-0 bg-transparent py-1 text-xs text-blue-700'
                        onClick={() => handleDrawerOpen(1)}
                      >
                        Devamını Göster
                      </UnstyledButton>
        ...
        <div>
          <Button
            ...
            size='md'
            radius='md'
            className='mb-2 flex justify-start py-2 font-medium md:mb-0'
