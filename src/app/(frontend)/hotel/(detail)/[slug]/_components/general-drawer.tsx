    ...
    <>
      {description && description.hotelInformation ? (
        <div className='rounded bg-white md:p-3'>
          ...
          <div className='my-10'>
            <ul className='flex w-[350px] gap-2 overflow-x-auto'>
              {data?.hotel.year_built && (
                <li className='flex w-auto items-center gap-3 rounded border bg-gray-50 p-1 px-4'>
          ...
          <Button
            ...
            className='my-3 bg-transparent p-0 text-sm font-medium text-blue-700 md:my-0'
          >
