...
import { NotFoundForm } from './_components/no-rooms-form'
...
const HotelDetailSection: React.FC<IProps> = ({ slug }) => {
  ...
  return (
    <>
      <div className='z-100 border-b p-1 md:py-4'>
        <Container className='p-1'>
          {!isBreakPointMatchesMd && (
            <div className='relative mb-3 flex items-center justify-between text-sm'>
              <button
                className='absolute start-0 end-0 top-0 bottom-0 z-10 mb-5'
                onClick={toggleSearchEngineVisibility}
              />

              <div className='grid items-center'>
                <div className='font-bold'>{hotel.destination}</div>
      ...
      <Container
        className='flex flex-col gap-3 px-0 sm:px-4 md:gap-5 md:py-0'
        id='mdx'
      >
        <div>
          <div className='grid grid-cols-2 items-center justify-between py-2 md:py-3'>
            ...
            <div className='col-span-2 flex items-center justify-center gap-1 text-xs text-gray-600 md:col-span-1 md:justify-end'>
              <span>
                Kültür ve Turizm Bakanlığı - Kısmı Turizm İşletme Belgesi:{' '}
                <span className='font-bold'> {hotel.documents?.at(0)?.no}</span>
              </span>
            </div>
          </div>
        ...
        <div className='grid grid-cols-2 gap-2 rounded bg-gray-50 md:grid-cols-12 md:gap-5 md:p-3'>
          <div className='col-span-12 flex flex-col gap-3 rounded bg-white p-3 md:col-span-8 md:gap-5'>
            <div className='grid'>
              <div className='text-xl font-semibold md:text-3xl'>
                {hotel.name.trim()}
              </div>
              <div className='gap-md grid items-center py-2 text-sm text-blue-800 md:flex'>
              ...
              <div className='flex h-full flex-col'>
                ...
                {generalInfoContentHeight > GENERAL_INFO_MAX_HEIGHT && (
                  <UnstyledButton
                    ...
                    className='mt-auto mb-3 flex items-center gap-1 bg-transparent text-sm font-medium text-blue-700'
                  >
                    <div>Tesisin tüm olanaklarını görün</div>
                    <div>
          ...
          <div className='col-span-12 flex flex-col gap-3 md:col-span-4'>
            {hotel.comment_info && (
              <div className='hidden items-center justify-between rounded bg-white p-3 py-2 md:flex'>
                <div className='hidden items-center gap-2 self-end text-blue-800 md:flex'>
                  <div className='rounded-md bg-blue-100 p-3 text-lg leading-none font-bold'>
                    {hotel.comment_info?.averageScore}
                  </div>
                  <div>
                    <div className='text-md font-bold'>Mükemmel</div>
                ...
                <BiChevronRight size={26} className='text-blue-800' />
              </div>
            )}
            <div
              className='hidden gap-3 rounded bg-white p-3 py-2 md:grid'
              data-heading='Konum'
            >
            ...
            <div className='hidden justify-between gap-5 rounded bg-white px-6 py-2 md:flex'>
              <div className='flex items-center gap-2'>
                <div>
                  <IconCheckIn />
                </div>
        ...
        <div className='rounded border bg-gray-50 p-2 md:bg-white'>
          <RoomUpdateForm />
        </div>
        ...
        <div className='relative grid gap-3 @lg:gap-5'>
          ...
          {roomsQuery.hasNextPage && (
            <div className='mt-3 mb-5 flex justify-center'>
              <Button
                className='rounded-md from-blue-800 to-blue-500 text-white shadow-xl transition-all duration-500 hover:from-blue-700 hover:to-blue-900'
                size='lg'
                type='button'
          ...
          <div ref={ratingTargetRef}>
            ...
            <div className='gap-2 rounded bg-gray-50 p-3'>
              <div className='flex items-center justify-between rounded-lg bg-white p-3'>
                <div className='hidden items-center gap-4 self-end text-blue-800 md:flex'>
                  <div className='rounded-md bg-blue-100 p-4 px-5 text-xl leading-none font-bold'>
                    {hotel.comment_info?.averageScore}
                  </div>
                  <div className='items-center gap-1'>
                    <div className='text-xl font-bold'>Mükemmel</div>
                    <div className='flex items-center'>
                ...
                <Button
                  ...
                  className='bg-transparent p-0 font-semibold text-blue-700'
                >
