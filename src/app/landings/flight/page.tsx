        ...
        <Container className='grid gap-3 py-5 md:gap-7 md:py-10'>
          <div className='flex flex-col gap-7 md:gap-12'>
            <div>
              ...
              <div className='xs:w-[500px] flex w-[325px] gap-4 overflow-x-auto font-semibold sm:w-[580px] md:grid md:w-full md:grid-cols-3 md:gap-4'>
                {teaser &&
                  teaser.length > 0 &&
                  teaser
                    ...
                    .map((item) => (
                      ...
                      >
                        <div className='grid h-full min-w-[260px] items-center gap-4 rounded-lg border bg-white p-2 py-4 shadow-xl md:min-w-0 md:p-3'>
                          <div>
                            <div
                              style={{
                                width: '50px',
                ...
                <div className='grid grid-cols-2 gap-4 md:grid-cols-4'>
                  {popularDomesticFlights.map((flight) => (
                    <ProductBox
                      ...
                      title={flight.title}
                      url={flight.params.link.value as Route}
                    />
                  ))}
                </div>
              </div>
            ...
            {popular_airlines.length > 0 && (
              <div>
                <Title fz={'h2'}>Popüler Hava Yolları</Title>
