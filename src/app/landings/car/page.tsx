    ...
    <div>
      <div className='relative border-b py-4'>
        <Image
          ...
          className='z-0'
        />
        <Container className='relative z-10 p-1'>
          <Title fz={'h2'} pb={'sm'} c={'white'}>
      ...
      <Container pt={{ base: 'md', sm: 'xl' }}>
        <div className='grid gap-6 md:gap-12'>
          ...
          <div>
            <Title fz={{ base: 'h4', md: 'h2' }} className='pb-3 text-center'>
              {providers?.title}
            </Title>
