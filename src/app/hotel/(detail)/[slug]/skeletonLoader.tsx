    ...
    <Container>
      <div className='flex flex-col gap-3 px-0 py-5 sm:px-4 md:gap-5 md:py-3'>
        <div className='hidden md:block'>
          <div className='hidden auto-cols-fr gap-4 sm:grid-cols-4 md:grid md:grid-rows-2'>
        ...
        <div className='grid auto-cols-fr gap-4 sm:grid-cols-2 md:hidden md:grid-rows-2'>
          <Skeleton className='aspect-16/9 h-full w-full rounded-md sm:col-start-[span_2] sm:row-start-[span_2]' />
        </div>
        <div className='grid grid-cols-2 gap-2 rounded bg-gray-50 md:grid-cols-12 md:gap-5 md:p-3'>
          <div className='col-span-12 flex flex-col gap-7 rounded bg-white p-3 md:col-span-8'>
            ...
            <div>
              ...
              <Skeleton h={20} w={130} className='mt-8 mb-4' />
          ...
          <div className='col-span-12 flex flex-col gap-3 md:col-span-4'>
            ...
            <div className='hidden space-y-3 rounded bg-white p-4 md:block'>
              <Skeleton h={20} w={140} />
            ...
            <div className='hidden rounded bg-white p-4 md:block'>
              <Skeleton h={200} w='100%' className='rounded-md' />
            </div>
          </div>
        </div>
        <div>
          ...
          <Skeleton h={20} w={150} className='mt-8 mb-4' />
          <div className='space-y-3'>
            <Skeleton h={16} w='100%' />
            <Skeleton h={16} w='95%' />
          </div>

          <Skeleton h={20} w={160} className='mt-8 mb-4' />
          ...
          <Skeleton h={20} w={140} className='mt-8 mb-4' />
          <div className='space-y-4'>
            <Skeleton h={120} w='100%' className='rounded-md' />
          </div>
