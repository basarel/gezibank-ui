...
const FlightSearchResultsInternational: React.FC<IProps> = ({
  ...
  return (
    <div className='group items-center gap-x-4 rounded-lg border shadow hover:border-blue-600 md:grid md:grid-cols-5'>
        ...
        {details.map((detail) => {
          ...
          return (
            <div
              ...
              key={detail.key}
            >
              <div className='start-0-0 absolute top-1/2 mt-4 h-8 w-1 -translate-y-1/2 rounded-tr-xl rounded-br-md bg-gray-400 group-hover:bg-blue-600 md:mt-0' />
                    ...
                    <div className='pt-3'>
                      <div className='flex items-center justify-center gap-3 text-sm text-gray-700'>
                        <div className='flex gap-1'>
                          {relatedSegment.map((segment) => {
                            const timeParts = segment.flightTime.split(':')
                            ...
                            const formattedTime =
                              hours > 0
                                ...
                                : `${minutes} dakika`
                            return <div key={segment.key}>{formattedTime}</div>
                          })}
                        </div>
