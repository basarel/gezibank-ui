...
type IProps = {
  defaultValues?: Partial<HotelSearchEngineSchemaType>
...
export const HotelSearchEngine: React.FC<IProps> = ({
  defaultValues,
  showCalendar = false,
  onCalendarClose = () => {},
}) => {
        ...
        <div className='col-span-17 sm:col-span-6 md:col-span-5'>
          <HotelCalendar
            ...
            onDateSelect={(dates) => {
              ...
              form.trigger(['checkinDate', 'checkoutDate'])
            }}
            onClose={() => {
              onCalendarClose()
            }}
