...
const TransferSearchEngine = () => {
  ...
  const switchWay = () => {
    ...
    setOriginLocationInputValue(destination.Slug)
    setDestinationLocationInputValue(origin.Slug)
      ...
      <div className='grid grid-cols-1 gap-2 md:grid-cols-34'>
          ...
          <div className='relative col-span-13 sm:col-span-6'>
            ...
            <Locations
              key={
                ...
                watchedDestinationLocation?.Code ??
                'destination'
              }
              label='Nereye'
        ...
        <div className='relative col-span-8 md:col-span-5'>
          ...
          <TransferCalendar
            ...
            defaultDate={dayjs(formActions.getValues('date')).toDate()}
          />
        </div>
        <div className='relative col-span-8 md:col-span-5'>
          <RiTimeLine
